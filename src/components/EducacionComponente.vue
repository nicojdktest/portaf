...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'En curso en segundo cuatrimestre de la carrera', enlace:'https://www.youtube.com/'},
  {fecha: '2024', title: 'Coderhouse', descripcion: 'Curso de Python donde me empecé a dedicar al campo del backend', enlace:'http:www.direccion.com'}
]);
</script>
