...
import { ref } from 'vue';
const titulo = 'Repositor supermercado';
const fecha = 'Desde Enero 2024 / Septiembre 2024';
const experiencias = ref([
    { id: 1, src: icono2, parrafo: 'Fui repositor en un supermercado chino. Tambien fui cajero en algunas ocaciones que se necesitaba' }
]);
</script>
