...
const intereses = ref([
    'Desarrollo Frontend con Vue: Me gusta crear interfaces de usuario interactivas utilizando Vue con algunas librerías que lo hacen mucho más facil',
    'Desarrollo Backend con Python: Me interesa desarrollar sistemas robustos y escalables utilizando Python, especialmente con frameworks como Django y Flask, para crear soluciones completas y eficientes desde el servidor hasta el cliente.',
    'Tecnologías Web: Me motiva mantenerme actualizado con las últimas tendencias en el desarrollo web usando librerías como Bootstrap, Bulma o Tailwind'
]);
